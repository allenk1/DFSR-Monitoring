...
## Purpose
This script will provide a simple reporting mechanism for DFSR. A scheduled task will run the script and send a report via email.

## Requirements
* This script has been test on Powershell version 4 and 5. But it should work in Powershell 3.
* This script assumes you have an SMTP relay onsite that allows anonymous authentication
...
_IF THERE ARE ANY BACKLOGS THEN A REPORT WILL SHOW WITH THE FILES THAT ARE NOT SYNCED_
---------------------------------------

## Thanks & Acknowlegements
The core DFSR check of this script was based on work by NullPayload. You can find him here: http://chris-nullpayload.rhcloud.com/2014/08/powershell-script-to-monitor-dfs-replication/
